...
def reconstruction(args):
    ...
    # update_AlphaMask_list = [1, 2000, 4000]
    ...
    if args.ckpt is not None:
        ...
        tensorf = eval(args.model_name)(
            ...
            # threshold for creating alpha mask volume
    ...
    # 最后一个分辨率基本就是300
    # 分辨率提升，体素的数量也跟着提升，这里就是体素的数量
    # linear in logrithmic space [3496047, 5828060, 9715614, 16196343, 26999994]
    ...
    for iteration in pbar:
        ...
        if iteration % args.progress_refresh_rate == 0:
            ...
            PSNRs = []
        # N_vis在这使用，数据集中的N_vis并未使用args.N_vis这个值
        # N_vis的值，就是渲染的图片的数量，因此跨度就是len(dataset)/N_vis
        ...
        if iteration in upsamp_list:
            # 取出一个新的体素的数量，体素数量越来越多，体素越来越小，分辨率越来越高
